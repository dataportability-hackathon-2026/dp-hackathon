...
export const metadata: Metadata = {
  ...
  description:
    "Core Model adapts to graduate students, working professionals, educators, medical students, law students, and career changers. Find your learning path.",
  keywords: [
    "adaptive learning students",
    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-12">
        ...
        <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mb-16">
          Whether you&apos;re in school, switching careers, or teaching others,
          Core Model adapts to your specific situation, schedule, and learning
          goals.
        </p>
      ...
      <section className="py-16 text-center">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 mb-6">
          Upload your materials, set your goals, and let Core Model build your

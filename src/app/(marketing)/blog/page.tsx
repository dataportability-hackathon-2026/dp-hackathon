...
export const metadata: Metadata = {
  ...
  description: "Evidence-based insights on spaced repetition, retrieval practice, metacognition, and adaptive learning. Research-backed articles for students, educators, and lifelong learners.",
  keywords: ["learning science blog", "study tips", "spaced repetition", "adaptive learning", "education research"],
}
    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-12">
        ...
        <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mb-16">
          Research-backed insights on how to study effectively, build lasting knowledge, and become a better learner. No fluff, just evidence.
        </p>
      ...
      <section className="py-16 text-center bg-neutral-50 dark:bg-neutral-900/50">
        <h2 className="text-2xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">Ready to Apply These Principles?</h2>
        <p className="text-neutral-600 dark:text-neutral-400 mb-6">Core Model puts learning science into practice with adaptive study plans and mastery tracking.</p>
        <a href="/dashboard">

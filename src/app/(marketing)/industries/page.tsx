...
export const metadata: Metadata = {
  ...
  description:
    "See how Core Model serves healthcare, technology, legal, higher education, finance, and creative arts professionals with industry-specific adaptive learning.",
  keywords: [
    "adaptive learning industries",
    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-12">
        ...
        <p className="text-lg text-neutral-600 dark:text-neutral-400 max-w-2xl mb-16">
          Every field has unique learning demands. Core Model adapts to the
          specific knowledge structures, compliance requirements, and
          professional standards of your industry.
        </p>
      ...
      <section className="py-16 text-center">
        ...
        <p className="text-neutral-600 dark:text-neutral-400 mb-6">
          Core Model works for any knowledge-intensive field. Try it free and
          see the difference.
        </p>
        <a href="/dashboard">
          <Button size="lg">

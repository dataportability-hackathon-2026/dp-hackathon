    ...
    <div className="min-h-screen bg-white dark:bg-neutral-950">
      ...
      <div className="max-w-6xl mx-auto px-6 pt-12 pb-20">
        ...
        <nav className="text-sm text-neutral-500 dark:text-neutral-400 mb-8">
          ...
          <a href="/resources" className="hover:text-neutral-700 dark:hover:text-neutral-300">Resources</a>
          <span className="mx-2">/</span>
          <span className="text-neutral-700 dark:text-neutral-300">{resource.title}</span>
        </nav>

        <div className="grid lg:grid-cols-3 gap-12">
          {/* Main Content */}
          <div className="lg:col-span-2">
            <Badge variant="outline" className="mb-4">{typeLabels[resource.type]}</Badge>
            ...
            {/* What's Inside */}
            <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">What&apos;s Inside</h2>
            ...
            {/* Preview */}
            <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-100 mb-4">Preview</h2>
            ...
            <div className="sticky top-24">
              <Card className="border-blue-200 dark:border-blue-800">
                <CardContent className="p-6">
                  ...
                  <a href={`/api/resources/pdf?slug=${resource.slug}`} target="_blank" rel="noopener noreferrer">
              ...
              <div className="mt-8 p-6 rounded-xl bg-neutral-50 dark:bg-neutral-900/50 border border-neutral-200 dark:border-neutral-800">
                ...
                <p className="text-sm text-neutral-600 dark:text-neutral-400 mb-4">
                  Core Model puts learning science into practice with adaptive study plans, spaced repetition, and mastery tracking.
                </p>
                <a href="/dashboard">

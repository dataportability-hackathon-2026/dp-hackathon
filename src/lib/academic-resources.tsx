...
const SemanticScholarLogo = createLogoComponent(
  "/logos/semantic-scholar.svg",
  "Semantic Scholar",
);
const ArxivLogo = createLogoComponent("/logos/arxiv.svg", "arXiv");
const OpenLibraryLogo = createLogoComponent(
  "/logos/open-library.svg",
  "Open Library",
);
...
export const ACADEMIC_RESOURCES: AcademicResource[] = [
  {
    ...
    description:
      "Comprehensive legal research guides and open resources from UT Austin",
    icon: UTAustinLogo,
  ...
  },
  {
    ...
    shortName: "Harvard",
    description:
      "Free online courses and learning resources from Harvard University",
    icon: HarvardLogo,
  ...
  },
  {
    ...
    shortName: "Stanford",
    description:
      "Free courses and educational content from Stanford University",
    icon: StanfordLogo,
  ...
  },
  {
    ...
    shortName: "Penn",
    description:
      "Courses from the University of Pennsylvania and Wharton School on Coursera",
    icon: PennLogo,
  ...
  },
  {
    ...
    description:
      "200M+ research papers with citation graphs across all disciplines",
  ...
  },
  {
    ...
    shortName: "CORE",
    description:
      "Full-text access to open access papers from thousands of repositories",
    icon: CoreLogo,
  ...
  },
  {
    ...
    shortName: "edX",
    description:
      "Structured course catalogs and real syllabi from top universities",
    icon: OpenEdxLogo,
  ...
  },
  {
    ...
    shortName: "MIT OCW",
    description:
      "2,500+ courses with syllabi, problem sets, and reading lists from MIT",
    icon: MitOcwLogo,

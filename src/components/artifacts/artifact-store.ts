...
export const MOCK_VIDEOS: VideoArtifact[] = [
  {
    ...
    description:
      "A visual walkthrough of eigenvalue computation for 2x2 and 3x3 matrices.",
    ...
    questions: [
      {
        ...
        correctIndex: 1,
        explanation:
          "Every vector is an eigenvector of I with eigenvalue 1, since Iv = 1v.",
      },
      {
        id: "q2",
        question:
          "If A has eigenvalue 3, what eigenvalue does A^2 have for the same eigenvector?",
        options: ["3", "6", "9", "27"],
        correctIndex: 2,
      ...
      },
      {
        id: "q3",
        question:
          "The characteristic polynomial of a 2x2 matrix is always degree:",
        options: ["1", "2", "3", "4"],
        correctIndex: 1,
        explanation:
          "For an nxn matrix, the characteristic polynomial det(A - lambda*I) has degree n.",
      },
      {
        id: "q4",
        ...
        correctIndex: 1,
        explanation:
          "The spectral theorem guarantees symmetric matrices have all real eigenvalues.",
      },
    ],
    createdAt: "2026-03-03",
  },
    ...
    questions: [
      {
        ...
        correctIndex: 0,
        explanation:
          "The zero matrix has no linearly independent rows or columns, so rank = 0.",
      },
      {
        id: "q6",
...
export const MOCK_FLASHCARDS: FlashcardArtifact[] = [
    ...
    cards: [
      {
        ...
        back: "det(A - lambda*I) = 0, where lambda are the eigenvalues.",
      },
      {
        id: "c2",
        front: "How do you find eigenvectors?",
        back: "Solve (A - lambda*I)x = 0 for each eigenvalue lambda.",
      },
      {
        id: "c3",
        front: "What does it mean if eigenvalues are all distinct?",
        back: "The matrix is diagonalizable and eigenvectors are linearly independent.",
      },
      {
        id: "c4",
        front: "Trace of a matrix equals...",
        back: "The sum of its eigenvalues (counted with multiplicity).",
      },
      {
        id: "c5",
        front: "Determinant of a matrix equals...",
        back: "The product of its eigenvalues.",
      },
      {
        id: "c6",
        front: "When is a matrix positive definite?",
        back: "When all its eigenvalues are strictly positive.",
      },
    ],
    createdAt: "2026-03-02",
  },
  {
    ...
    cards: [
      {
        id: "c7",
        front: "When can you multiply two matrices A (m x n) and B?",
        back: "B must have n rows. Result is m x (cols of B).",
      },
      {
        id: "c8",
        front: "Is matrix multiplication commutative?",
        back: "No! AB does not equal BA in general.",
      },
    ],
    createdAt: "2026-03-01",
  },
    ...
    cards: [
      {
        ...
        back: "A non-empty subset closed under addition and scalar multiplication.",
      },
      {
        id: "c10",
        front: "What is a basis?",
        back: "A linearly independent spanning set for the vector space.",
      },
    ],
    ...
    sections: [
      {
        heading: "Overview",
        content:
          "This week you completed 4 out of 5 scheduled study blocks, spending a total of 2 hours and 15 minutes on active practice. Your overall mastery increased from 48% to 55%.",
      },
      {
        heading: "Key Achievements",
        content:
          "Matrix operations mastery reached 72%, passing the intermediate threshold. You correctly solved 3 consecutive application problems on determinants without hints.",
      },
      {
        heading: "Areas for Improvement",
        content:
          "Eigenvalue computation accuracy dropped during timed sessions. Consider practicing under less time pressure first, then gradually introducing time constraints.",
      },
      {
        heading: "Recommendations",
        content:
          "Focus next week on eigenvector properties and diagonalization. The system has automatically adjusted your Day 3 and Day 5 blocks to emphasize these topics.",
      },
    ],
    createdAt: "2026-03-03",
  },
    ...
    slides: [
      {
        ...
        bullets: [
          "Scalar lambda such that Av = lambda*v",
          "Found via characteristic equation det(A - lambda*I) = 0",
      ...
      },
      {
        ...
        bullets: [
          "A = PDP^(-1) where D is diagonal of eigenvalues",
          "P is matrix of eigenvectors as columns",
          "Only possible when there are n linearly independent eigenvectors",
        ],
      },
      {
...
export const MOCK_SPATIALS: SpatialArtifact[] = [
  {
    ...
    description:
      "3D model of a water molecule showing oxygen and hydrogen atoms with bonds.",
    autoRotate: true,
    objects: [
      {
        id: "o1",
  ...
  },
  {
    ...
    description:
      "Interactive 3D view of all five Platonic solids — the building blocks of geometry.",
    autoRotate: true,
    objects: [
      {
        id: "p1",
  ...
  },
  {
    ...
    description:
      "Visualization of standard basis vectors e1, e2, e3 in R3 with unit cube.",
    autoRotate: true,
    objects: [
      {
        id: "origin",
...
export const MOCK_MANIMS: ManimArtifact[] = [
  {
    ...
    description:
      "Visualizes how a 2x2 matrix transforms the unit square, showing shearing and scaling effects.",
...
class MatrixTransform(Scene):
  ...
  },
  {
    ...
    description:
      "Shows eigenvectors staying on their span while other vectors rotate under a linear transformation.",
    code: `from manim import *
...
class EigenViz(Scene):
  ...
  },
  {
    ...
    description:
      "Animated vector field showing how vectors flow under a differential system dx/dt = Ax.",
    code: `from manim import *
import numpy as np
...
export const MOCK_GEOS: GeoArtifact[] = [
  {
    ...
    description:
      "Major international trade flows between world cities visualized as arcs.",
    arcs: [
      {
        from: { name: "Los Angeles", coordinates: [-118.24, 34.05] },
        to: { name: "Shanghai", coordinates: [121.47, 31.23] },
        value: 850,
      },
      {
        from: { name: "New York", coordinates: [-74.0, 40.71] },
        to: { name: "London", coordinates: [-0.12, 51.51] },
        value: 720,
      },
      {
        from: { name: "Tokyo", coordinates: [139.69, 35.69] },
        to: { name: "Singapore", coordinates: [103.85, 1.29] },
        value: 640,
      },
      {
        from: { name: "Dubai", coordinates: [55.27, 25.2] },
        to: { name: "Mumbai", coordinates: [72.88, 19.08] },
        value: 530,
      },
      {
        from: { name: "Rotterdam", coordinates: [4.47, 51.92] },
        to: { name: "New York", coordinates: [-74.0, 40.71] },
        value: 480,
      },
      {
        from: { name: "Shanghai", coordinates: [121.47, 31.23] },
        to: { name: "Hamburg", coordinates: [9.99, 53.55] },
        value: 610,
      },
      {
        from: { name: "San Francisco", coordinates: [-122.42, 37.77] },
        to: { name: "Tokyo", coordinates: [139.69, 35.69] },
        value: 420,
      },
      {
        from: { name: "Sydney", coordinates: [151.21, -33.87] },
        to: { name: "Singapore", coordinates: [103.85, 1.29] },
        value: 380,
      },
      {
        from: { name: "London", coordinates: [-0.12, 51.51] },
        to: { name: "Dubai", coordinates: [55.27, 25.2] },
        value: 510,
      },
      {
        from: { name: "Sao Paulo", coordinates: [-46.63, -23.55] },
        to: { name: "Rotterdam", coordinates: [4.47, 51.92] },
        value: 350,
      },
    ],
  ...
  },
  {
    ...
    arcs: [
      {
        from: { name: "MIT", coordinates: [-71.09, 42.36] },
        to: { name: "Stanford", coordinates: [-122.17, 37.43] },
        value: 920,
      },
      {
        from: { name: "Harvard", coordinates: [-71.12, 42.37] },
        to: { name: "UC Berkeley", coordinates: [-122.26, 37.87] },
        value: 780,
      },
      {
        from: { name: "Caltech", coordinates: [-118.13, 34.14] },
        to: { name: "MIT", coordinates: [-71.09, 42.36] },
        value: 650,
      },
      {
        from: { name: "Princeton", coordinates: [-74.66, 40.35] },
        to: { name: "U Chicago", coordinates: [-87.6, 41.79] },
        value: 540,
      },
      {
        from: { name: "Stanford", coordinates: [-122.17, 37.43] },
        to: { name: "Carnegie Mellon", coordinates: [-79.94, 40.44] },
        value: 470,
      },
      {
        from: { name: "Georgia Tech", coordinates: [-84.4, 33.77] },
        to: { name: "MIT", coordinates: [-71.09, 42.36] },
        value: 410,
      },
      {
        from: { name: "U Michigan", coordinates: [-83.74, 42.28] },
        to: { name: "Stanford", coordinates: [-122.17, 37.43] },
        value: 380,
      },
      {
        from: { name: "UT Austin", coordinates: [-97.73, 30.29] },
        to: { name: "UC Berkeley", coordinates: [-122.26, 37.87] },
        value: 320,
      },
    ],
...
export function getArtifactsByType(type: ArtifactType): Artifact[] {
  switch (type) {
    ...
    case "audio":
      return MOCK_AUDIO;
    case "mindmap":
      return MOCK_MINDMAPS;
    case "quiz":
      return MOCK_QUIZZES;
    case "datatable":
      return MOCK_DATATABLES;
    case "flashcards":
      return MOCK_FLASHCARDS;
    case "report":
      return MOCK_REPORTS;
    case "infographic":
      return MOCK_INFOGRAPHICS;
    case "slidedeck":
      return MOCK_SLIDEDECKS;
    case "spatial":
      return MOCK_SPATIALS;
    case "manim":
      return MOCK_MANIMS;
    case "geo":
      return MOCK_GEOS;
